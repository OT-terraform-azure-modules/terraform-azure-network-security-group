...
resource "azurerm_network_security_rule" "predefined_rules" {
  ...
  source_address_prefix                      = lookup(var.predefined_rules[count.index], "source_application_security_group_ids", null) == null && var.src_address_prefixes == null ? join(",", var.src_address_prefix) : null
  source_address_prefixes                    = lookup(var.predefined_rules[count.index], "source_application_security_group_ids", null) == null ? var.src_address_prefixes : null
...
resource "azurerm_network_security_rule" "custom_rules" {
  ...
  source_address_prefix                      = lookup(var.custom_rules[count.index], "source_application_security_group_ids", null) == null && lookup(var.custom_rules[count.index], "src_address_prefixes", null) == null ? lookup(var.custom_rules[count.index], "src_address_prefix", "*") : null
  source_address_prefixes                    = lookup(var.custom_rules[count.index], "source_application_security_group_ids", null) == null ? lookup(var.custom_rules[count.index], "src_address_prefixes", null) : null
